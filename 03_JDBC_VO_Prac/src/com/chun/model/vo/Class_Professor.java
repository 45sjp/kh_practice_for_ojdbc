...
public class Class_Professor extends Class {
	...
	public Class_Professor(String studentNo, String studentName, String studentSSN, String studentAddress,
			Date entranceDate, String absenceYN, String coachProfessorNo, String termNo, String classNo, double point,
		...
		super(studentNo, studentName, studentSSN, studentAddress, entranceDate, absenceYN, coachProfessorNo, termNo,
				classNo, point, preattendingClassNo, className, classType);
		this.professorNo = professorNo;
	}
