...
public class Professor extends Class_Professor {
	...
	public Professor(String studentNo, String studentName, String studentSSN, String studentAddress, Date entranceDate,
		...
		super(studentNo, studentName, studentSSN, studentAddress, entranceDate, absenceYN, coachProfessorNo, termNo,
				classNo, point, preattendingClassNo, className, classType, professorNo);
		this.professorName = professorName;
		this.professorSSN = professorSSN;
		this.professorAddress = professorAddress;
	}
