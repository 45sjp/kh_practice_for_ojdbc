...
public class Grade extends Student {
	...
	public Grade(String studentNo, String studentName, String studentSSN, String studentAddress, Date entranceDate,
			String absenceYN, String coachProfessorNo, String termNo, String classNo, double point) {
		super(studentNo, studentName, studentSSN, studentAddress, entranceDate, absenceYN, coachProfessorNo);
		this.termNo = termNo;
		this.classNo = classNo;
		this.point = point;
	}
